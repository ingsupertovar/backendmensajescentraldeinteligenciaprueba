...
$sql = "INSERT INTO aprobacion (cedula, codigo, correo, descripcion)
VALUES ('$CC','$CO','$COR','$DES')";
...
if ($conn->query($sql) === TRUE) {
            ...
            while ($columna1 = mysqli_fetch_array($result1))
              ...
              if (mysqli_num_rows($result1) > 0) {	
				...
				$body = "Tu proceso fue aprobado con el codigo . $CO si quieres puedes descargarlo en el siguiente link  http://www.localhost/t01/appgestion.html " ;
 ...
 header("Location: /t01/apgestion.htm");
...
"<center><h1>Lo siento, Este correo no se encuentra registrado</h1></center>
    ...
    echo "Error grave en la base de datos Vuelva a intentarlo " . $sql . "<br>" . $conn->error;
}
