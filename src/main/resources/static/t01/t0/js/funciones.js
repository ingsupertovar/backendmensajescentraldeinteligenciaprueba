...
function agregardatos(cedula,codigo,correo,descripcion,departamento,municipio){

   cadena="cedula=" + cedula + "&codigo=" + codigo + "&correo=" + correo + "&descripcion=" + descripcion + "&departamento=" + departamento + "&municipio=" + municipio;
