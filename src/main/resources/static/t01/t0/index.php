...
.................
<div class="modal fade" id="modalEdicion1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Actualizar datos111</h4>
      </div>
      <div class="modal-body">
          <input type="text" hidden="" id="idpersona11" name="">
          <label>cedula</label>
          <input type="text" name="" id="cedulauu" class="form-control input-sm">
          <label>Codigo</label>
          <input type="text" name="" id="codigouu" class="form-control input-sm">
           <label>Correo</label>
          <input type="text" name="" id="correouu" class="form-control input-sm">
          <label>Descripcion</label>
          <input type="text" name="" id="descripcionuu" class="form-control input-sm">
          <label>Departamento</label>
          <input type="text" name="" id="departamentouu" class="form-control input-sm">
          <label>Municipio</label>
          <input type="text" name="" id="municipiouu" class="form-control input-sm">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-warning" id="actualizadatos1" data-dismiss="modal">Actualizar</button>
